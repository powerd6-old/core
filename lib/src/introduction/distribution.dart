...
class Distribution extends Content with Indexable {
  ...
  String toHtml() {
    return """
      ...
      <p>See the ${Reference(link: "#${recommendedAppendix.heading.getId()}", text: "appendix: ${recommendedAppendix.heading.title}").toHtml()}for a list of some recommended books.</p>
""";
  }
