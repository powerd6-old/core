...
class Distribution extends Content with Indexable {
  ...
  String toHtml() {
    return '${heading.toHtml()}'
        ...
        '<p>See the ${Reference.internal(link: recommendedAppendix.heading.getId(), text: "appendix: ${recommendedAppendix.heading.title}").toHtml()}for a list of some recommended books.</p>';
  }
