...
class TurnOrder extends MarkdownContent with Indexable {
  static Heading heading = Heading(title: "Turn Order");
  ...
  final Indexable actions;
  TurnOrder({required this.actions}) : super(markdown: """
${heading.toHtml()}
