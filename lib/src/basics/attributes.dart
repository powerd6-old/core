...
""");
  ...
  static Attribute strength = Attribute(
      ...
      focuses: [
        ...
        Focus(
            name: "Endurance",
            description: "Endurance represents resilience and longevity."
        ...
        Focus(
            name: "Toughness",
            description: "Similar to endurance, but with less emphasis on time."
  ...
  static Attribute charisma = Attribute(
      ...
      focuses: [
        Focus(
            name: "Likeability",
            description: "Likeable character's are the fun of the party."
                "Getting invited to an event, receiving praises for your work or winning a popularity contest rely on likeability.",
            concept: "You are an adored performer, or a popular aristocrat."
  ...
  static Attribute agility = Attribute(
      ...
      focuses: [
        Focus(
            name: "Flexibility",
            description: "A flexible body is a thing of wonders."
                "Fitting in small spaces, moving around traps or pulling off acrobatic manoeuvres all need flexibility.",
            concept:
                "Your comrades truly believe you liquefy yourself when infiltrating a target location. Only that explains how you managed to contort and climb into all those little spaces."
        ...
        Focus(
            ...
            concept:
                "There is no doubt in your movements, as long as you can see it, you can probably dodge it."
                "As a bonus, you never dropped your mother's vase by accident."),
        Focus(
            name: "Speed",
            description: "Speed represents your body's ability to move fast."
  ...
  static Attribute wisdom = Attribute(
      ...
      focuses: [
        Focus(
            name: "Judgment",
            description: "Judgment is the ability to use knowledge effectively."
        ...
        Focus(
            ...
            concept:
                "You are a walking encyclopedia, or you've simply mastered all the fauna and flora of your religion."
  ...
  static Attribute dexterity = Attribute(
      ...
      focuses: [
        Focus(
            ...
            concept:
                "Some people struggle coordinating their two arms, but you could probably deal with two or three more without a hitch."
                "Complex movements with multiple steps are natural to you."),
        Focus(
            name: "Grace", // TODO: Consider renaming to Poise
            description: "Graceful and beautiful movements."
                "Dancing, balancing on a rope or mixing chemicals relate to grace.",
            concept:
                "You are a craftsman with precise movements. Your body moves like a fine instrument, be it sewing, brewing or dancing."
